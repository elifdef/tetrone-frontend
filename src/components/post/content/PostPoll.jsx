...
export default function PostPoll({ poll, postId, isOwner }) {
    ...
    const handleTotalVotesClick = (e) => {
        if (!poll.is_anonymous && totalVotes > 0) {
            openVotersModal(optionsToRender[0]?.id, e);
        }
    };
        ...
        <div className="tetrone-poll">
            ...
            <div className="tetrone-poll-meta tetrone-poll-meta-spaced">
                <div className="tetrone-poll-meta-left">
                    <span
                        className={!poll.is_anonymous && totalVotes > 0 ? "tetrone-poll-total-clickable" : ""}
                ...
                {isOwner && !isClosed && (
                    <button className="tetrone-poll-close-btn" onClick={handleClosePollClick}>
                        {t('action.close')}
                    </button>
                )}
            </div>
