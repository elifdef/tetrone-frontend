...
export default function StickerEditorModal({stickerToEdit = null, onClose, onSuccess, onDelete})
{
    ...
    return (
        <Modal
            isOpen={true}
            onClose={onClose}
            title={isEditMode ? t('stickers.edit_sticker') : t('stickers.add_sticker')}
            sizeClass="modal-lg"
            ...
            <div className="tetrone-sticker-editor-layout">
                <div className="tetrone-sticker-editor-form">
                    ...
                    <div className="tetrone-form-group tetrone-mt-15">
                        <label className="tetrone-classic-form-label">{t('stickers.table_shortcode')}</label>
                        <input
                            type="text"
                            className={`tetrone-classic-input tetrone-w-full ${!isShortcodeValid && shortcode.length > 0 ? 'tetrone-input-error' : ''}`}
                            value={shortcode}
                    ...
                    <div className="tetrone-form-group tetrone-mt-15">
                        <label className="tetrone-classic-form-label">{t('stickers.tags')}</label>
                        <input
                            type="text"
                            className={`tetrone-classic-input tetrone-w-full ${!isKeywordsValid ? 'tetrone-input-error' : ''}`}
                            value={keywords}
